...
def ngram(words,n):
	...
	return output
inicio=time()
archivo=open("Flujo_experimental_1/partes1.txt",'r')
archivo1=open("Flujo_experimental_1/lema1.txt",'w')
archivo2=open('Flujo_experimental_1/prueba_final.txt','w')
...
archivo9=open('Flujo_experimental_1/tiempo.txt','w')
...
topico=open("Flujo_experimental_1/topicos1.txt",'r')
topicos=[]
